...
do
     ...
     print "2-point perspective demo - M0KSR      FreeBASIC 0.16w mod G7TKM"
     ...
     'lines to top vertex
     line (vp1x, vp1y)-(p1x, p1y), &h888888
     line (vp2x, vp2y)-(p1x, p1y), &h888888
     ...
     'form cube
     aline (p1x, p1y, getangle(p1x, p1y, vp1x, vp1y), 50)
     line (p1x, p1y)-(currentx, currenty)
     line (vp2x, vp2y)-(currentx, currenty), &h888888
     line (currentx, currenty)-(currentx, dropline(currentx, currenty))
     
     '...and from the other V.P.
     aline (p1x, p1y, getangle(p1x, p1y, vp2x, vp2y), 50)
     line (p1x, p1y)-(currentx, currenty)
     line (vp1x, vp1y)-(currentx, currenty), &h888888
     line (currentx, currenty)-(currentx, dropline(currentx, currenty))
